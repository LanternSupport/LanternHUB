...
--! configuration
local service = 30277;  -- your service id, this is used to identify your service.
local secret = "64c980ce-e305-4a36-b6b9-c5d9da904b0a";  -- make sure to obfuscate this if you want to ensure security.
...
-- ========================================== --
-- Lantern HUB - Fluent UI Loader (PlatoBoost)
-- ========================================== --

local Fluent = loadstring(game:HttpGet("https://github.com/dawid-scripts/Fluent/releases/latest/download/main.lua"))()

onMessage = function(message)
    Fluent:Notify({ Title = "System", Content = message, Duration = 3 })
end
...
Tabs.Login:AddButton({
    ...
    Callback = function()
        Fluent:Notify({ Title = "Checking", Content = "Verifying key...", Duration = 1 })
        
        local success = verifyKey(currentInputKey)
        
        if success then
            Fluent:Notify({ Title = "Success", Content = "Key correct! Loading Lantern HUB...", Duration = 3 })
            Window:Destroy()
            task.wait(0.5)
            pcall(function()
...
Tabs.Login:AddButton({
    Title = "Get Key",
    Description = "Copy the link to get today's key.",
    Callback = function()
        copyLink()
        Fluent:Notify({ 
            Title = "Copied!", 
